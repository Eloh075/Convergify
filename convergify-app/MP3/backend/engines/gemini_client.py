...
class GeminiClient:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.available_keys = EngineConfig.GEMINI_API_KEYS.copy()
        ...
        logger.info(f"Initialized Gemini client with model: {EngineConfig.GEMINI_MODEL}")
    ...
    def generate_text(
        ...
        """
        temperature = temperature or EngineConfig.GEMINI_TEMPERATURE
        max_tokens = max_tokens or EngineConfig.GEMINI_MAX_TOKENS
        ...
        try:
            ...
            if retry_count < EngineConfig.MAX_LLM_RETRIES:
                delay = EngineConfig.RETRY_INITIAL_DELAY * (
                    EngineConfig.RETRY_BACKOFF_FACTOR ** retry_count
                )
                ...
                logger.error(f"All {EngineConfig.MAX_LLM_RETRIES} retries failed")
                raise
    ...
    def generate_json(
        ...
        is_gemma = "gemma" in EngineConfig.GEMINI_MODEL.lower()
